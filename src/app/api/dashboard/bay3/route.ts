...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const facilityName = body.facilityName || "Alessandro";
    ...
    // includeAllCustomers is accepted for API compatibility;
    // the Next.js path returns all planned orders by default.
    ...
    return NextResponse.json(
      { message: "Team 3 data is unavailable." },
      { status: 200 },
    );
  }
}
